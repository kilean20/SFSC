...
inline double
dx_Drift(short nx, short npx, short nz, short npz, STATvec & sigma, double  r, double  Ksc, double  denom){
    double temp=0.0;
    nx-=1;
...
inline double
dz_Drift(short nx, short npx, short nz, short npz, STATvec & sigma, double  r, double  Ksc, double  denom){
    double temp=0.0;
    nz-=1;
...
inline double
dpx_Drift(short nx, short npx, short nz, short npz, STATvec & sigma, double  r, double  Ksc, double  denom){
    double temp=0.0;
    npx-=1;
...
inline double
dpz_Drift(short nx, short npx, short nz, short npz, STATvec & sigma, double  r, double  Ksc, double  denom){
    double temp=0.0;
    npz-=1;
