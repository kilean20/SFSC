...
inline double
dx_eQuad(unsigned nx, unsigned npx, unsigned nz, unsigned npz, STATvec & sigma, double  r, double K1, double  Ksc, double  denom){
    double temp=0.0;
    nx-=1;
...
inline double
dz_eQuad(unsigned nx, unsigned npx, unsigned nz, unsigned npz, STATvec & sigma, double  r, double K1, double  Ksc, double  denom){
    double temp=0.0;
    nz-=1;
...
inline double
dpx_eQuad(unsigned nx, unsigned npx, unsigned nz, unsigned npz, STATvec & sigma, double  r, double K1, double  Ksc, double  denom){
    double temp=0.0;
    npx-=1;
...
inline double
dpz_eQuad(unsigned nx, unsigned npx, unsigned nz, unsigned npz, STATvec & sigma, double  r, double K1, double  Ksc, double  denom){
    double temp=0.0;
    npz-=1;
...
//void sc_eQuadPass(STATvec & sigma, double  L, double Ksc, unsigned Nint){
    //double K1=0.0;
